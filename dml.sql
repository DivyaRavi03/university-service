INSERT INTO Students (name, gender, email_id, personal_email_id, joining_term, joining_year, phone_number, nationality)
VALUES ('John Doe', 'Male', 'john.doe@university.edu', 'johndoe@gmail.com', 'FALL', 2023, '1234567890', 'USA'),
       ('Jane Smith', 'Female', 'jane.smith@university.edu', 'janesmith@yahoo.com', 'WINTER', 2022, '0987654321',
        'Canada'),
       ('Alice Johnson', 'Female', 'alice.johnson@university.edu', 'alicej@yahoo.com', 'SUMMER', 2024, '9876543210',
        'UK'),
       ('Bob Williams', 'Male', 'bob.williams@university.edu', 'bobw@gmail.com', 'FALL', 2021, '5678901834', 'Germany'),
       ('Charlie Brown', 'Other', 'charlie.brown@university.edu', 'charlieb@gmail.com', 'WINTER', 2023, '2345678901',
        'France'),
       ('David Miller', 'Male', 'david.miller@university.edu', 'davidm@yahoo.com', 'FALL', 2022, '3456789012', 'USA'),
       ('Emma Wilson', 'Female', 'emma.wilson@university.edu', 'emmaw@gmail.com', 'SUMMER', 2023, '4567890123',
        'Canada'),
       ('Frank Thomas', 'Male', 'frank.thomas@university.edu', 'frankt@gmail.com', 'WINTER', 2024, '5678901234', 'UK'),
       ('Grace Lee', 'Female', 'grace.lee@university.edu', 'gracel@gmail.com', 'FALL', 2021, '6789012345', 'Germany'),
       ('Henry Martin', 'Male', 'henry.martin@university.edu', 'henrym@gmail.com', 'SUMMER', 2022, '7890123456',
        'France'),
       ('Isabella Moore', 'Female', 'isabella.moore@university.edu', 'isabellam@gmail.com', 'WINTER', 2023,
        '8901234567', 'USA'),
       ('Jack Taylor', 'Male', 'jack.taylor@university.edu', 'jackt@gmail.com', 'FALL', 2022, '9012345678', 'Canada'),
       ('Karen Anderson', 'Female', 'karen.anderson@university.edu', 'karena@gmail.com', 'SUMMER', 2023, '1234509876',
        'UK'),
       ('Liam Harris', 'Male', 'liam.harris@university.edu', 'liamh@gmail.com', 'WINTER', 2024, '2345609875',
        'Germany'),
       ('Mia Clark', 'Female', 'mia.clark@university.edu', 'miac@gmail.com', 'FALL', 2021, '3456709864', 'France'),
       ('Noah Lewis', 'Male', 'noah.lewis@university.edu', 'noahl@gmail.com', 'SUMMER', 2022, '4567809853', 'USA'),
       ('Olivia Walker', 'Female', 'olivia.walker@university.edu', 'oliviaw@gmail.com', 'WINTER', 2023, '5678909842',
        'Canada'),
       ('Paul Hall', 'Male', 'paul.hall@university.edu', 'paulh@gmail.com', 'FALL', 2022, '6789009831', 'UK'),
       ('Quincy Scott', 'Other', 'quincy.scott@university.edu', 'quincys@gmail.com', 'SUMMER', 2023, '7890109820',
        'Germany');
